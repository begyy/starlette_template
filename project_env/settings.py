...
path = sys.path.append(os.path.join(BASE_DIR, 'apps'))
config = Config("../.env")

DB_DRIVER = config("DB_DRIVER", default="postgresql")
DB_HOST = config("DATABASE_HOST", default=None)
DB_PORT = config("DB_PORT", cast=int, default=None)
DB_USER = config("DB_USER", default="starlette_user")
DB_PASSWORD = config("DB_PASSWORD", cast=Secret, default="starlette_password")
DB_DATABASE = config("DB_DATABASE", default="starlette_template")
DB_DSN = config(
    "DB_DSN",
    cast=make_url,
    default=URL(
